...
const KontaktPoziv = () => {
  return (
    <section className="px-6 sm:px-10 lg:px-18  2xl:px-28 py-26 bg-gray-500/80 flex flex-col md:flex-row justify-between items-end gap-16">
      <div className="">
      ...
      <Link
        href="/kontakt"
        className="py-4 px-10 bg-gray-800 rounded-4xl text-white font-bold text-3xl inline-block cursor-pointer hover:bg-gray-600 transition-all duration-500 md:mx-0 mx-auto"
      >
        Kontakt
      </Link>
    </section>
