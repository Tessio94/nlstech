...
const Cover = () => {
	return (
		<section className="max-[400px]:relative lg:bg-none bg-[url('/landing-mobile.jpg')] bg-no-repeat bg-cover h-screen lg:h-auto lg:min-h-[unset] min-h-[800px]">
			<Image
			...
			<div className="xsm:gap-4 xsm:p-5 absolute z-0 flex  flex-col items-center  rounded-2xl p-6  gap-8 top-[50%] left-[50%] translate-y-[-50%] lg:translate-y-[-80%] translate-x-[-50%]  xl:translate-y-[-50%] w-[95%] lg:w-[80%]">
				<h1 className="text-white text-5xl sm:text-6xl font-extrabold tracking-widest uppercase xl:text-7xl font-mont text-center max-[360px]:text-4xl">
